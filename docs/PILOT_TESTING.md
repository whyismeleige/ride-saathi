...
- Try an unsaved place in English and Hindi, including “take me to Apollo Hospital” and “मुझे अपोलो अस्पताल जाना है”. Check the query, the actual first three search results (served through the Ride Saathi backend), addresses, and selected map pin. Include another city explicitly and verify results are not restricted to Home.
